...
<link rel="stylesheet" href="/baemin/resources/css/member/view_one_store_detail.css">
...
<div class="top-viewStore">
          ...
          <!-- 평균별점 사진, 글-->
          <div  class="star"><span>⭐⭐⭐</span><span>3.5???</span></div>
          <!-- 리뷰 총 갯수 -->
          ...
          <div class="delivery-information">
                  <div>   <span>가게 주소:</span>  <span>${memberViewStoreInforVo.address} ${memberViewStoreInforVo.addressDetail}</span></div>
                  <div>   <span>최소주문금액:</span>  <span>${memberViewStoreInforVo.minimumOrderAmount}</span><span>원</span></div>
                  <div>   <sapn>배달시간:30분</span> </div>
                  <div>   <span>배달팁: 무료</span> </div>
          </div>
          <!-- 메뉴/가게정보/리뷰     3가지 탭-->
          <div class="select-tab">
                <div class="tab1" id="menuTab">
                   <span>메뉴 </span>  </div>
                <div class="tab2" id="storeInfoTab"><span>가게정보</span></div>
                <div class="tab3" id="reviewTab"><span>리뷰</span></div>    
          </div>
</div>
...
<div class="under-viewFood">
     ...
     <c:forEach items="${storeOfFoodCategoryVoList}" var="storeOfFoodCategoryVo">
	        <div class="categoryList">
	              ...
	              <c:forEach items="${storeOfFoodCategoryVo.foodInforVoList}" var="FoodInforVo" >
			                <div class="category-foodContentList">
			                        <!--category-foodContentList 안은 왼쪽 오른쪽 디브로 나눔. 왼쪽은 food-info/ 오른쪽은 음식이미지-->
			                          <div class="food-info">
			                                  <div class="foodName">메뉴자리 ${FoodInforVo.name}</div>
			                                  <div class="foodPrice"> <span>메뉴가격 ${FoodInforVo.price}</span> <span></span>원</div>
			                          </div>
			                          
			                          <div class="count-button"> 
			                            <button>-</button>장바구니<button>+</button>
			
			                          </div>
			                          <img  width="90" height="90" src="/baemin/resources/upload/${FoodInforVo.foodImg}.png">
			                </div>
					</c:forEach>			 				<!-- 같은 카테로리 안에서 반복  -->
    ...
    <div id="storeInfoTab-content" style="display: none;">
      ...
      <div class="operationInfo-right">
        ...
        <c:forEach items="${memberViewStoreInforVo.closedayList}" var="ClosedayVo">
...
<div class="mainPhoto">
	      <!-- 크기 변경 고정하길!!! -->
	      <img width="250px" height="250px" src="baemin/resources/수인img/가게대표사진.jpg">
	      
	      <img width="250px" height="250px" src="baemin/resources/img/store/.jpg">
	    </div>
